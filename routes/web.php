...
use App\Http\Middleware\bloqueMiddleware;
...
Route::middleware([bloqueMiddleware::class])->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::delete('/colocation.removeMember/{Col_id}/{user_id}', [ColocationController::class, 'removeMember'])->name('colocation.removeMember');
        Route::delete('/colocation.leave/{Col_id}', [ColocationController::class, 'leaveMember'])->name('colocation.leave');
    });
});
